...
public class WebEventListener extends TestBase implements WebDriverEventListener {
	...
	public void beforeFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println(" Trying to before Find By" + by.toString());
		
	}

	public void afterFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println(" Trying to after Find By" + by.toString());
		
	}

	public void beforeClickOn(WebElement element, WebDriver driver) {
		System.out.println(" Trying to before Click On" + element.toString());
		
	}

	public void afterClickOn(WebElement element, WebDriver driver) {
		System.out.println(" Trying to after Click On" + element.toString());
